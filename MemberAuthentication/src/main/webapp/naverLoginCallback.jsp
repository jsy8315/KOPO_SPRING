...
<html>
  ...
  <body>
    ...
    String redirectURI = URLEncoder.encode("http://192.168.123.23:8080/MemberAuthentication/naverLoginCallback.jsp", "UTF-8");
    String apiURL;
    ...
    if (access_token != null) { // access_token을 잘 받아왔다면
        try {
            ...
            // 왼쪽 변수 이름은 원하는 대로 정하면 됨
            // 단, 우측의 get()안에 들어가는 값은 원하는 속성 이름으로 변경해야 함!!!
            //네이버디벨로퍼에 변수명 있으니 보고 확인
